export default function PlannerPage() {
  return (
    <div className="px-6 py-8 max-w-5xl">
      ...
      >
        <p className="text-sm font-semibold" style={{ color: "rgba(255,255,255,0.4)" }}>Planner coming soon</p>
        <p className="text-xs" style={{ color: "rgba(255,255,255,0.25)" }}>Weekly timetable with subject slots and revision reminders.</p>
      </div>
    </div>
  );
}
