export default function BookmarksPage() {
  return (
    <div className="px-6 py-8 max-w-5xl mx-auto">
      ...
      >
        <p className="text-sm font-semibold" style={{ color: "rgba(var(--fg-rgb),0.4)" }}>Bookmarks coming soon</p>
        <p className="text-xs" style={{ color: "rgba(var(--fg-rgb),0.25)" }}>Save PYQs and NCERT solutions to revisit later.</p>
      </div>
    </div>
  );
}
