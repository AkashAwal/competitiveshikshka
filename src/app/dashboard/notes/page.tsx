export default function NotesPage() {
  return (
    <div className="px-6 py-8 max-w-5xl mx-auto">
      ...
      >
        <p className="text-sm font-semibold" style={{ color: "rgba(var(--fg-rgb),0.4)" }}>Notes coming soon</p>
        <p className="text-xs" style={{ color: "rgba(var(--fg-rgb),0.25)" }}>Create and manage your revision notes here.</p>
      </div>
    </div>
  );
}
