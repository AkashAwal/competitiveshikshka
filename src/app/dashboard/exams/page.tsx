export default function ExamsPage() {
  return (
    <div className="px-6 py-8 max-w-5xl">
      ...
      <p className="text-sm mb-8" style={{ color: "rgba(255,255,255,0.45)" }}>Exam dates, admit card releases, result announcements and important alerts.</p>
      <div
      ...
      >
        <p className="text-sm font-semibold" style={{ color: "rgba(255,255,255,0.4)" }}>Notifications coming soon</p>
        <p className="text-xs" style={{ color: "rgba(255,255,255,0.25)" }}>JEE and NEET exam alerts will appear here.</p>
      </div>
    </div>
  );
}
