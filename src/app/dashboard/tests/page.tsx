export default function TestsPage() {
  return (
    <div className="px-6 py-8 max-w-5xl mx-auto">
      ...
      >
        <p className="text-sm font-semibold" style={{ color: "rgba(var(--fg-rgb),0.4)" }}>Tests coming soon</p>
        <p className="text-xs" style={{ color: "rgba(var(--fg-rgb),0.25)" }}>Full test series with analytics will be available here.</p>
      </div>
    </div>
  );
}
